     ...
     <div class="col-md-12">
       <div class="card mt-5">
         <div class="card-header">
            <div class="col-md-12">
                <h4 class="card-title">Client-Route Mappings
                  <a class="btn btn-success ml-5" href="{{route('route_maps.create')}}">Add Client Route Map</a>
                </h4>
            </div>
         </div>
         <div class="card-body">
  ...
  $(function () {
   ...
   $('body').on('click', '.showItem', function () {
     ...
     $.ajax({
       ...
       success: function (data) {
          // console.log('Succ:', data);
          window.location = "{{ route('route_maps.index') }}" +'/' + data ;
       },
       error: function (data) {
         console.log('Errorr:', data);
